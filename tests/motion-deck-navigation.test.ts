...
assert.equal(clampFrameIndex(99, frameCount), 2);
...
assert.equal(getFrameIndexFromHash("#/motion-deck/99", frameCount), 2);
...
assert.equal(createFrameHash(99, frameCount), "#/3");
