...
- [x] Build-time and runtime offline code use the same manifest shape.
- [x] Runtime offline state can represent success, unavailable features, and errors consistently.
- [x] Existing offline artifacts are still generated during build.
- [x] The single-file HTML output still inlines script, style, and asset references correctly.
- [x] Focused tests cover manifest shape and at least one single-file HTML replacement case.
- [x] `pnpm check` passes.
- [x] `pnpm build` passes.
